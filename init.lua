...
require("lazy").setup({require("theme"), require("plugin.neo-tree"), require("plugin.telescope"),
                       require("plugin.treesitter"), require("plugin.bufferline"), require("plugin.lsp"), require("plugin.format_lint"),require("plugin.autocomplete"),require("plugin.autopair"), require("plugin.dap"),require("plugin.git-conflict"),require("plugin.diffview"),require("plugin.lualine")})
